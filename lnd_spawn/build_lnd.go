...
func Build() {
	...
	set := &Settings{
		PathToBtcsuiteBTCDRepo: `D:\PICFIGHT\src\github.com\lightningnetwork\lnd`,
		PathToPicfightPFCDRepo: `D:\PICFIGHT\src\github.com\picfight\pfclnd`,
	...
	injector.PerformInjections(set.PathToPicfightPFCDRepo, filepath.Join("", "code_injections", "lnd"))
