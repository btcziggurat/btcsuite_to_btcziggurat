...
func Build() {
	...
	set := &Settings{
		PathToBtcsuiteBTCDRepo: `D:\PICFIGHT\src\github.com\lightninglabs\neutrino`,
		PathToPicfightPFCDRepo: `D:\PICFIGHT\src\github.com\picfight\pfcneutrino`,
	...
	injector.PerformInjections(set.PathToPicfightPFCDRepo, filepath.Join("", "code_injections", "neutrino"))
