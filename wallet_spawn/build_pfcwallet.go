...
func Build() {
	...
	set := &Settings{
		PathToBtcsuiteBTCDRepo: `D:\PICFIGHT\src\github.com\btcsuite\btcwallet`,
		PathToPicfightPFCDRepo: `D:\PICFIGHT\src\github.com\picfight\pfcwallet`,
	...
	injector.PerformInjections(set.PathToPicfightPFCDRepo, filepath.Join("", "code_injections", "wallet"))
	...
	//projectops.GoBuild(set.PathToPicfightPFCDRepo)
